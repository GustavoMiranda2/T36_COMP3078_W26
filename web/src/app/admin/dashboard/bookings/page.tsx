          ...
          <div className="mt-5 space-y-3">
            {loading ? (
              ...
              sortedAppointments.map((appointment) => (
                <EditableRow
                  key={appointment.id}
                  title={<>{appointment.user.display_name || appointment.user.email} - {appointment.service.name}{appointment.user.phone ? <> <span className="font-normal text-[#0f0a1e]">|</span> <span className="text-[#9b97b0]">{appointment.user.phone}</span></> : null}</>}
