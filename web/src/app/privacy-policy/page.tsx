    ...
    <article className="mx-auto max-w-4xl rounded-[2rem] border border-[#e6dccf] bg-[#fffaf2] p-8 text-[#1d1712] shadow-[0_20px_70px_rgba(29,23,18,0.08)] sm:p-10">
      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-[#3a3028]">
        <section>
          ...
          <p>
            We collect account details such as name, email address, and password, plus booking data such as
            selected services, appointment times, notes, and booking history. If you submit a testimonial, we
            also store the review text and rating.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your information may be processed by our hosting, database, and email delivery providers when needed
            to operate the booking service. We do not sell personal information.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <a className="font-semibold text-[#8f5a36] underline" href="/account/delete">
              account deletion page
            </a>{' '}
            on our website. Deleting your account removes your customer profile, appointment history, and your
            submitted testimonials from the live booking system.
          </p>
        </section>
